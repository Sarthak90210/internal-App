...
export const InventoryService = {
  ...
  // ancestor folder's holder (see lib/custody.js). Delegates to assignHolder /
  // updateInventoryStatus so hold-history stays consistent with manual assigns.
  ...
  // ─── ITEM CUSTODY ─────────────────────────────────────────────────
  // Items can now carry their own explicit holder (a user may grab a single
  // consumable, e.g. flux). This is a whole-doc hold — quantity is untouched.
