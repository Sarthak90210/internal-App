...
// Default on-device randomness. Lazy-required so importing this module in a
// plain Node context (tests, tooling) never touches expo-crypto — tests always
// inject their own RNG instead.
